...
export const todoService = {
   ...
   * @param filter 过滤条件对象
   */
  getTodoList: (limit, offset, filter) => {
    let myFilter = filter || {
      myType: 'ALL',
      myDays: 'ALL'
    }
  ...
  getTodoDetail: (wfid, wfinst, zjid) => {
    if (
      wfid === 'OA_GZRZ' ||
      wfid === 'DMG_CPWD' ||
      wfid === 'CGJS_FKSQ' ||
      ...
      this.IsGetTodoDetail = true
      /*let mastercols = {
                FYDJ_DJID: { name: "FYDJ_DJID", type: "String" },
                KJDW_JC: { name: "KJDW_JC", type: "String" },
                FYLX_MC: { name: "FYLX_MC", type: "String" },
                FYDJ_QSRQ: { name: "FYDJ_QSRQ", type: "String" },
                FYDJ_ZZRQ: { name: "FYDJ_ZZRQ", type: "String" },
                FYDJ_BXRQ: { name: "FYDJ_BXRQ", type: "Integer" },
                RYXX_MC: { name: "RYXX_MC", type: "String" },
                BM_BMMC: { name: "BM_BMMC", type: "String" },
                FYDJ_BXSY: { name: "FYDJ_BXSY", type: "String" },
                FYDJ_ZFDX: { name: "FYDJ_ZFDX", type: "String" },
                ZFDXMC: { name: "ZFDXMC", type: "String" },
                FYDJ_CYRYMC: { name: "FYDJ_CYRYMC", type: "String" },
                FYDJ_BXZE: { name: "FYDJ_BXZE", type: "String" },
                FYDJ_ZFJE: { name: "FYDJ_ZFJE", type: "String" },
                FYDJ_SSLB: { name: "FYDJ_SSLB", type: "String" },
                FYDJ_SWID: { name: "FYDJ_SWID", type: "String" },
                FYDJ_ZT: { name: "FYDJ_ZT", type: "String" },
                FYDJ_BZ: { name: "FYDJ_BZ", type: "String" },
                FYDJ_WHR: { name: "FYDJ_WHR", type: "String" },
                FYDJ_WHSJ: { name: "FYDJ_WHSJ", type: "String" },
                FYDJ_WFWUSERNAME: { name: "FYDJ_WFWUSERNAME", type: "String" },
                FYDJ_WFHUSERNAME: { name: "FYDJ_WFHUSERNAME", type: "String" }
            };
            this.detailcols = {
                FYDJMX_XH: { name: "FYDJMX_XH", type: "Integer" },
                FYXM_XMMC: { name: "FYXM_XMMC", type: "String" },
                HB_MC: { name: "HB_MC", type: "String" },
                FYDJMX_QSRQ: { name: "FYDJMX_QSRQ", type: "String" },
                FYDJMX_ZZRQ: { name: "FYDJMX_ZZRQ", type: "Integer" },
                FYDJMX_CDRYMC: { name: "FYDJMX_CDRYMC", type: "String" },
                FYDJMX_FPJE: { name: "FYDJMX_FPJE", type: "String" },
                FYDJMX_SQBXJE: { name: "FYDJMX_SQBXJE", type: "String" },
                FYDJMX_BXBZ: { name: "FYDJMX_BXBZ", type: "String" },
                FYDJMX_BZ: { name: "FYDJMX_BZ", type: "String" }
            };*/
      this.params = JSON.stringify({
        action: 7,
        functype: 2,
      ...
      /* let mastercols = {
                KJDW_JC: { name: "KJDW_JC", type: "String" },
                FYLX_MC: { name: "FYLX_MC", type: "String" },
                WZLYDJ_SWID: { name: "WZLYDJ_SWID", type: "String" },
                WZLYDJ_DJID: { name: "WZLYDJ_DJID", type: "String" },
                WZLYDJ_LYRQ: { name: "WZLYDJ_LYRQ", type: "String" },
                WZLYDJ_QSRQ: { name: "WZLYDJ_QSRQ", type: "Integer" },
                WZLYDJ_ZZRQ: { name: "WZLYDJ_ZZRQ", type: "String" },
                RYXX_MC: { name: "RYXX_MC", type: "String" },
                BM_BMMC: { name: "BM_BMMC", type: "String" },
                WZLYDJ_SYRYMC: { name: "WZLYDJ_SYRYMC", type: "String" },
                WZLYDJ_LYSY: { name: "WZLYDJ_LYSY", type: "String" },
                WZLYDJ_ZT: { name: "WZLYDJ_ZT", type: "String" },
                WZLYDJ_BZ: { name: "WZLYDJ_BZ", type: "String" },
                WZLYDJ_SQID: { name: "WZLYDJ_SQID", type: "String" },
                WZLYDJ_WHR: { name: "WZLYDJ_WHR", type: "String" },
                WZLYDJ_WHSJ: { name: "WZLYDJ_WHSJ", type: "String" },
                WZLYDJ_WFWUSERNAME: { name: "WZLYDJ_WFWUSERNAME", type: "String" },
                WZLYDJ_WFHUSERNAME: { name: "WZLYDJ_WFHUSERNAME", type: "String" }
            };
            this.detailcols = {
                WZLYDJMX_XH: { name: "WZLYDJMX_XH", type: "Integer" },
                WZLYDJMX_WLXX: { name: "WZLYDJMX_WLXX", type: "String" },
                WZLYDJMX_WLPH: { name: "WZLYDJMX_WLPH", type: "String" },
                WZLYDJMX_XQSL: { name: "WZLYDJMX_XQSL", type: "String" },
                WZLYDJMX_YFSL: { name: "WZLYDJMX_YFSL", type: "Integer" },
                WZLYDJMX_LYSL: { name: "WZLYDJMX_LYSL", type: "String" },
                WZLYDJMX_SYRMC: { name: "WZLYDJMX_SYRMC", type: "String" },
                WZLYDJMX_XQID: { name: "WZLYDJMX_XQID", type: "String" },
                FYXM_XMMC: { name: "FYXM_XMMC", type: "String" },
                WZLYDJMX_BZ: { name: "WZLYDJMX_BZ", type: "String" }
            };*/
      params = JSON.stringify({
        action: 7,
        functype: 2,
    ...
    let url = 'rshareapi'
    let body = 'action=7&params=' + params
    if (IsGetTodoDetail) {
      return httpService.post(url, body)
    } else {
