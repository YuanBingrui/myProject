...
export default {
  ...
  methods: {
    getFlowInfo() {
      ...
      todoService
        .getFlowInfo(_self.todo.WFAWT_WFID, _self.todo.WFAWT_INST)
        .then(res => {
    ...
    changeProctype(taskProctype) {
      ...
      todoService
        .getHandleContent(
          _self.todo.WFDEF_CLASS,
          _self.todo.WFAWT_PID,
          _self.todo.WFAWT_WFID,
          _self.todo.WFAWT_INST,
          taskProctype
        )
        .then(res => {
          if (res.data && 0 === res.data.errcode) {
    ...
    onSubmit() {
      ...
      params.task_classid = this.todo.WFDEF_CLASS
      params.task_id = this.todo.WFAWT_WFID
      params.task_inst = this.todo.WFAWT_INST
      params.task_statusid = this.todo.WFAWT_PID
      params.task_nextsid = this.todo.WFAWT_PID
      params.action = 4
